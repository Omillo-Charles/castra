                            ...
                            <div key={item.id}
                                ...
                                <div className="flex flex-col sm:flex-row items-center gap-2 flex-shrink-0">
                                    <button type="button"
                                        ...
                                        className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-zinc-100 text-zinc-950 text-xs font-bold hover:bg-[#C6A16A] hover:text-zinc-950 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 whitespace-nowrap">
