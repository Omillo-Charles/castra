...
import { ProductModal } from "@/components/modals/products";
    ...
    return (
        <>
            <article
                ...
                className="group relative flex flex-col bg-[#171717] rounded-2xl border border-zinc-800 overflow-hidden shadow-sm hover:shadow-lg hover:border-[#C6A16A]/40 transition-all duration-300 cursor-pointer"
            >
                {/* Image area */}
                <div className="relative w-full aspect-square bg-zinc-900 overflow-hidden">
                    ...
                    <button
                        ...
                        className="absolute top-3 right-3 p-2 rounded-full bg-zinc-900/90 border border-zinc-700 shadow-sm opacity-0 group-hover:opacity-100 transition-all duration-200 hover:border-[#C6A16A]/60 hover:scale-110 disabled:cursor-not-allowed z-10"
