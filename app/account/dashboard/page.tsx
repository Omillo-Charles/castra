        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div className="flex-1 w-full min-w-0">
                    {section === "overview"  && <Overview  setSection={setSection} user={user} />}
...
/* ══ OVERVIEW ══════════════════════════════════════════════════════════════ */
function Overview({ setSection, user }: { setSection: (s: Section) => void; user: typeof DUMMY_USER }) {
...
/* ══ PROFILE ═══════════════════════════════════════════════════════════════ */
function Profile({ user }: { user: typeof DUMMY_USER }) {
        ...
        <div className="space-y-5">
            ...
            <form onSubmit={handleSave} className="bg-white dark:bg-[#171717] rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 space-y-5">
                ...
                <div className="flex items-center gap-3 pt-1">
                    <button
                        type="submit"
                        className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#C6A16A] hover:bg-[#b59059] text-zinc-950 font-bold text-sm transition-all shadow-sm"
                    >
                        Save Changes
                    </button>
                    {saved && (
