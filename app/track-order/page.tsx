                ...
                <div className="space-y-6">
                    ...
                    <div className={`flex items-center gap-4 px-6 py-4 rounded-2xl border ${
                        ...
                        <div>
                            ...
                            <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-0.5">{STEPS[stepIndex].desc}</p>
                        </div>
                    </div>
                                ...
                                return (
                                    <div key={step.key} className="flex items-stretch gap-4">
                                        ...
                                        <div className={`pb-6 pt-1 ${i === STEPS.length - 1 ? "pb-0" : ""}`}>
                                            <p className={`text-sm font-semibold transition-colors ${active ? "text-[#C6A16A]" : completed ? "text-zinc-700 dark:text-zinc-300" : "text-zinc-400 dark:text-zinc-600"}`}>
                                                {step.label}
                                                {active && (
                                            ...
                                            <p className={`text-xs mt-0.5 transition-colors ${pending ? "text-zinc-300 dark:text-zinc-700" : "text-zinc-400 dark:text-zinc-500"}`}>
                                                {step.desc}
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div className="px-6 py-5 space-y-4">
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold text-zinc-800 dark:text-zinc-200 text-xs">{order.firstName} {order.lastName}</p>
                                </div>
                                <div>
