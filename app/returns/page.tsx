    ...
    return (
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
            ...
            <nav className="flex items-center gap-1.5 text-xs text-zinc-400 mb-8">
                ...
                <span className="text-zinc-300 font-semibold">Returns & Exchanges</span>
            </nav>
            ...
            <div className="space-y-8">
                ...
                <div className="rounded-2xl border border-red-500/20 bg-red-500/5 overflow-hidden">
                    ...
                    <div className="px-6 py-5 space-y-4">
                        ...
                        <p className="text-xs text-zinc-400 leading-relaxed pt-1 border-t border-red-500/20">
                ...
                <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 overflow-hidden">
                    ...
                    <div className="px-6 py-5 space-y-5">
                        <p className="text-sm text-zinc-400 leading-relaxed">
                            <span className="font-semibold text-zinc-200">Castra Kicks</span> (footwear) are eligible for <span className="font-bold text-emerald-400">size exchanges only</span> - no refunds. To qualify for an exchange, all of the following conditions must be met:
                        </p>
                        ...
                        <p className="text-xs text-zinc-400 leading-relaxed pt-1 border-t border-emerald-500/20">
                ...
                <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 overflow-hidden">
                    ...
                    <div className="px-6 py-5 space-y-3">
                        <p className="text-sm text-zinc-400 leading-relaxed">
                            If your order arrives damaged or you receive the wrong item, contact us <span className="font-semibold text-zinc-200">immediately</span> via WhatsApp with:
                        </p>
                ...
                {/* Contact CTA */}
                <div className="rounded-2xl bg-zinc-900 border border-zinc-800 p-7 text-center space-y-4 mt-4">
